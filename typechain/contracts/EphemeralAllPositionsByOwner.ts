...
export interface EphemeralAllPositionsByOwnerInterface extends utils.Interface {
  functions: {
...
export interface EphemeralAllPositionsByOwner extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EphemeralAllPositionsByOwnerInterface;

...
```*/
    ...
    ///Container for all the [`IERC721Permit`](self) function calls.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IERC721PermitCalls {
        const NAME: &'static str = "IERC721PermitCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IERC721PermitCalls>] = &[
                {
                    fn supportsInterface(
                        ...
                        <supportsInterfaceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC721PermitCalls::supportsInterface)
                    }
                    supportsInterface
                },
                {
                    fn getApproved(
                        ...
                        <getApprovedCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC721PermitCalls::getApproved)
                    }
                    getApproved
                },
                {
                    fn approve(
                        ...
                        <approveCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC721PermitCalls::approve)
                    }
                    approve
                },
                {
                    fn transferFrom(
                        ...
                        <transferFromCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC721PermitCalls::transferFrom)
                    }
                    transferFrom
                },
                {
                    fn PERMIT_TYPEHASH(
                        ...
                        <PERMIT_TYPEHASHCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC721PermitCalls::PERMIT_TYPEHASH)
                    }
                    PERMIT_TYPEHASH
                },
                {
                    fn DOMAIN_SEPARATOR(
                        ...
                        <DOMAIN_SEPARATORCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC721PermitCalls::DOMAIN_SEPARATOR)
                    }
                    DOMAIN_SEPARATOR
                },
                {
                    fn safeTransferFrom_0(
                        ...
                        <safeTransferFrom_0Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC721PermitCalls::safeTransferFrom_0)
                    }
                    safeTransferFrom_0
                },
                {
                    fn ownerOf(
                        ...
                        <ownerOfCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC721PermitCalls::ownerOf)
                    }
                    ownerOf
                },
                {
                    fn balanceOf(
                        ...
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC721PermitCalls::balanceOf)
                    }
                    balanceOf
                },
                {
                ...
                },
                {
                    fn setApprovalForAll(
                        ...
                        <setApprovalForAllCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC721PermitCalls::setApprovalForAll)
                    }
                    setApprovalForAll
                },
                {
                    fn safeTransferFrom_1(
                        ...
                        <safeTransferFrom_1Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC721PermitCalls::safeTransferFrom_1)
                    }
                    safeTransferFrom_1
                },
                {
                    fn isApprovedForAll(
                        ...
                        <isApprovedForAllCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC721PermitCalls::isApprovedForAll)
                    }
                    isApprovedForAll
                },
            ];
    ...
    ///Container for all the [`IERC721Permit`](self) events.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IERC721PermitEvents {
        const NAME: &'static str = "IERC721PermitEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IERC721PermitEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Approval(inner) => {
    ...
    /**Creates a new wrapper around an on-chain [`IERC721Permit`](self) contract instance.

See the [wrapper's documentation](`IERC721PermitInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IERC721PermitInstance<T, P, N> {
        IERC721PermitInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IERC721PermitInstance<T, P, N>>,
    > {
        IERC721PermitInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IERC721PermitInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IERC721Permit`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IERC721Permit`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IERC721PermitInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IERC721PermitInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IERC721PermitInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IERC721PermitInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IERC721PermitInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IERC721PermitInstance<T, P, N> {
            IERC721PermitInstance {

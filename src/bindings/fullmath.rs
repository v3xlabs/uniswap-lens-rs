...
```*/
    ...
    ///Container for all the [`FullMath`](self) custom errors.
    pub enum FullMathErrors {
        #[allow(missing_docs)]
    ...
    impl FullMathErrors {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[174u8, 71u8, 247u8, 2u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for FullMathErrors {
        const NAME: &'static str = "FullMathErrors";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<FullMathErrors>] = &[
                {
                    fn FullMulDivFailed(
                        data: &[u8],
                        validate: bool,
                        ...
                        <FullMulDivFailed as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(FullMathErrors::FullMulDivFailed)
                    }
                    FullMulDivFailed
                },
            ];

...
pub mod IPeripheryImmutableState {
    use super::*;
...
```*/
    ...
    ///Container for all the [`IPeripheryImmutableState`](self) function calls.
    ...
    #[automatically_derived]
    impl IPeripheryImmutableStateCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IPeripheryImmutableStateCalls {
        const NAME: &'static str = "IPeripheryImmutableStateCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IPeripheryImmutableStateCalls>] = &[
                {
                    fn WETH9(
                        data: &[u8],
                        validate: bool,
                        ...
                        <WETH9Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IPeripheryImmutableStateCalls::WETH9)
                    }
                    WETH9
                },
                {
                    fn factory(
                        ...
                        <factoryCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IPeripheryImmutableStateCalls::factory)
                    }
                    factory
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IPeripheryImmutableState`](self) contract instance.

See the [wrapper's documentation](`IPeripheryImmutableStateInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IPeripheryImmutableStateInstance<T, P, N> {
        IPeripheryImmutableStateInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IPeripheryImmutableStateInstance<T, P, N>>,
    > {
        IPeripheryImmutableStateInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IPeripheryImmutableStateInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IPeripheryImmutableState`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IPeripheryImmutableState`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IPeripheryImmutableStateInstance<
        T,
        P,
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IPeripheryImmutableStateInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IPeripheryImmutableStateInstance")
                .field(&self.address)
                .finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IPeripheryImmutableStateInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IPeripheryImmutableStateInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IPeripheryImmutableStateInstance<T, P, N> {
            IPeripheryImmutableStateInstance {
